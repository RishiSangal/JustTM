...
public class NetStatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_net_stat, container, false);
        lv= (ListView) v.findViewById(R.id.gpsList);
        TextView tv= (TextView) v.findViewById(R.id.netstatus);
        tv.setText("Net Status");
        getDAta(url);
    ...
    public void getDAta(String s) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                Log.e("response in netStatus",response);
